...
const home = {
    ...
    subline: (
        <>
            I'm {person.name}, a software developer at{" "}
            <InlineCode>Unitronic</InlineCode>, where I craft intuitive user
            experiences. After hours, I dive into expanding on my own projects.
        </>
    ),
};
...
const about = {
    ...
    intro: {
        ...
        description: (
            <>
                {person.firstName} is a dedicated software developer with a
                deep-seated passion for crafting intuitive, high-performance
                digital experiences. With expertise spanning user interface (UI)
                to data structures and visualization, {person.firstName} has a
                talent for transforming complex challenges into elegant,
                effective solutions that blend design with cutting-edge
                technology.
            </>
        ),
    },
        ...
        experiences: [
            {
                ...
                achievements: [
                    <>
                        Assemble electronic components, including circuit
                        boards, and wiring harnesses
                    </>,
                    <>Inspect and test incoming and assembled components</>,
                    <>
                        Troubleshooting and resolve issues with defective
                        components
                    </>,
            ...
            },
            {
                ...
                achievements: [
                    <>
                        Develop programs that identify and troubleshoot
                        assembled circuit boards and wiring harnesses
                    </>,
                    <>
                        Developing front-end applications to remotely tune
                        customer vehicles
                    </>,
                    <>Build desktop applications to analyze large datasets</>,
                    <>
                        Assist in optimization and structure of translation
                        algorithms from binary to json
                    </>,
                ],
                images: [
                    // optional: leave the array empty if you don't want to display images
        ...
        institutions: [
            {
                ...
                description: (
                    <>Currently Studying Software Engineering (2024-Present)</>
                ),
            },
            {
                name: "Vanier College",
                description: (
                    <>
                        Completed DEC in Computer Science and Mathematics
                        (2022-2024)
                    </>
                ),
            },
        ...
        skills: [
            {
                ...
                description: (
                    <>
                        Able to create visually appealing and reactive
                        weblications for the browser
                    </>
                ),
                images: [
                    {
            ...
            },
            {
                ...
                description: (
                    <>
                        Create scripts and tools to analyse large amounts of
                        data
                    </>
                ),
                images: [
